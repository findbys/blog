  ...
  ai: [
    {
      name: 'AI 辅助编程',
      color: '#00d4ff',
      icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4ff" stroke-width="1.5"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z"/><path d="M12 8v4l3 3"/></svg>',
      level: 90,
      brief: 'Cursor / Trae / Qoder AI IDE 高效使用',
      tags: ['Cursor', 'Trae', 'Qoder', 'Copilot'],
      points: ['熟练使用 Cursor 进行 AI 辅助代码生成', '掌握 Trae 智能调试与代码修复', '使用 Qoder 提升代码质量分析效率', '能高效利用 AI 工具提升开发速度'],
      since: '1+ 年',
      projects: '全覆盖',
    },
    {
      name: 'Prompt 工程',
      color: '#7b2fff',
      icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7b2fff" stroke-width="1.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',
      level: 82,
      brief: '高效 Prompt 设计 / AI 能力集成',
      tags: ['Prompt', 'ChatGPT', 'Claude', 'API 集成'],
      points: ['掌握结构化 Prompt 编写技巧', '能将 AI API 集成到业务产品中', '了解 RAG 检索增强生成基础', '具备 AI 辅助技术文档生成经验'],
      since: '1+ 年',
      projects: '5+ 项目',
    },
  ],
